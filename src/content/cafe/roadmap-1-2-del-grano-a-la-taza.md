...
description: 'La planta de café, las variedades, los métodos de procesamiento y cómo cada paso afecta lo que terminas probando.'
...
1. **Piel (exocarpio)** — la capa exterior, roja o amarilla cuando madura
2. **Pulpa (mesocarpio)** — capa dulce y mucilaginosa
3. **Mucílago** — capa pegajosa rica en azúcares que rodea el grano
4. **Pergamino (endocarpio)** — capa protectora como papel
