---
title: 'Pressure, temperature, and pre-infusion'
description: 'The machine variables that affect your extraction: how 9 bars work, thermal stability, and the power of pre-infusion.'
...
1. **CO2 releases.** Fresh coffee has trapped CO2 that creates turbulence and channeling when water hits it hard. Pre-infusion lets that gas escape first.
...
1. Brew your standard recipe at 93°C and note the flavor
2. Raise to 95°C keeping everything else the same. What changed?
3. Lower to 91°C. What changed?
4. Write the differences — you train your palate to connect temperature with profile

If your machine has pre-infusion:

1. Extract with pre-infusion on and without it (if you can turn it off)
2. Compare: which has more crema? Which tastes cleaner? Which is more consistent between shots?
