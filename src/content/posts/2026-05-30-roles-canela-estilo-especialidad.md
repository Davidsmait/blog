---
title: 'Roles de canela estilo cafetería de especialidad'
description: 'Por qué un rol de canela de cafetería vale lo que vale, y cómo acercarte en casa: masa enriquecida con tangzhong, fermentación en frío overnight, horno eléctrico, y el diario honesto de mi primera tanda (que terminó oliendo a cerveza).'
...
6. Saca el molde y déjalo **atemperar y terminar de leudar** sobre la barra: 1-2 horas según qué tan fría esté tu cocina. No mires el reloj, mira la masa: deben verse hinchados, tocándose entre sí y temblar ligeramente al mover el molde.
7. Mientras tanto, precalienta el horno.
8. Vierte la crema tibia entre los rolls y hornea.
...
<iframe src="/widgets/roles-canela-paso-a-paso.html" title="Guía interactiva paso a paso de roles de canela" loading="lazy" style="width:100%;height:880px;border:1px solid rgba(0,0,0,.12);border-radius:16px;background:transparent"></iframe>
